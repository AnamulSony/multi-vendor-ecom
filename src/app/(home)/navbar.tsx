...
export default function Navbar() {
  ...
  return (
    <nav className='h-20 flex border-b justify-between font-medium bg-white'>
        ...
        <NabarSidebar items={navbarItems} open = {isSidebarOpen} onOpenChange={setSidebarOpen}/>
         ...
         <div className='hidden lg:flex'>
            ...
            <Button asChild variant={'secondary'} className='border-l border-t-0 border-r-0 border-b-0 px-12 h-full rounded-none bg-black hover:bg-pink-400 transition-colors text-lg  text-white hover:text-black'>
